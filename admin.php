            ...
            <div class="modal-content"> 
              ...
              <div class="modal-body">
               <div class="row"> 
                 ...
                 <form role="form" action="api/admin/index.php/inviteAdmin" method="post" id="inviteAdmin">
                   <div class="box-body">
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover dataTable ">
                   <thead>
                    ...
                    <tbody>
                      <?php
                       $data =$adminObject ->getAllAdmin(1);
                      echo $data;
                     ?>
                    </tbody>                   
                  </table>
...
<?php include("footer.php");?>
    ...
    $("#inviteAdmin").submit(function(event){
