...
# --- URL SETTINGS ---
define('URL', "http://192.168.1.18:80/nowitest/");
//define('URL', "http://192.168.0.101/nowitest/");
//define('URL', "http://192.168.0.100/nowitest/"); // We need to replace server's IP address here
...
define('TABLE_PARENT_DISCUSSION', '`parent_discussion`');
