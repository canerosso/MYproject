	...
	function updateprofile($params){
	       ...
	       $mob=$params['mobile'];
                  ...
                  if($file!="")
			{
				    ...
				    if(@file_exists("../../prof_img/".$filename)==true)
				    {
				    
				    	@unlink("../../prof_img/".$filename);

				    }
				     if(@file_exists("../../prof_img/".$bimg)==true)

 						{
				       $bimage = '../../prof_img/'.$bimg;
		                @unlink($bimage);
						}

						$myfile = fopen("../../prof_img/".$filename, "w");

						if ($im !== false) {
						imagepng($im,'../../prof_img/'.$filename);
						imagedestroy($im);
