...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Excellence | Top 25 Scorers</title>
              ...
              <div class="col-xs-12">
                <div class="box">
                  <div class="box-header">
                    <h3 class="box-title">Top 25 Scorers </h3>
                    <hr />
                  </div><!-- /.box-header -->
                <div class="box-body">
                   ...
                   <tbody>
                      <?php 
					  		...
					  		if(isset($_GET['Id']))
							{
								$result=$testobj->getTop25Scorers($_GET['Id']);
								foreach($result as $row)
								{
  ...
  <script type="text/javascript">
   $('#tbl-top-scorers-list').DataTable({});
		...
		$("#test").change(function(){ 
            ...
            {
                window.location='top-scorers-report.php?Id='+$(this).val();
            }
